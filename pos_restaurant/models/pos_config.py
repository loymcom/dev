...
class PosConfig(models.Model):
    ...
    floor_ids = fields.One2many('hotel.floor', 'pos_config_id', string='Restaurant Floors', help='The restaurant floors served by this point of sale.')
    ...
    def get_tables_order_count(self):
        """         """
        self.ensure_one()
        tables = self.env['hotel.room'].search([('floor_id.pos_config_id', 'in', self.ids)])
